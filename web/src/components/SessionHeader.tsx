  ...
  return (
    <div className="shdr" style={{ flexDirection: "column", alignItems: "stretch", gap: 8 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
        ...
        {resolution && (
          <span className={`chip-sm ${resolution === "resolved" ? "res-ok" : resolution === "unverified" ? "res-unver" : resolution === "unresolved" ? "res-fail" : resolution === "indeterminate" ? "res-ind" : "res-part"}`}>
            {resolution}
          </span>
        )}
        {errorSteps > 0 && (
